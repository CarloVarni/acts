...
inline bool xyzCoordinateCheck(
  ...
  const Acts::Vector3& bottomStripDirection = spacePointInfo[sp.index()].bottomStripDirection;
  const Acts::Vector3& stripCenterDistance = spacePointInfo[sp.index()].stripCenterDistance;
